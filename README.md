...
The updated version of the TS-GAN that uses the up-to-date TensorFlow 2.12 and Atomistic Simulation Environment (ASE) to speed up the code is available in the `updated` [branch](https://github.com/ekraka/TS-GAN/tree/updated_tf212). 
